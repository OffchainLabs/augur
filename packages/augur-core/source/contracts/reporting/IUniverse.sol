...
import "../uniswap/interfaces/IUniswapV2Exchange.sol";
...
contract IUniverse {
    ...
    function deposit(address _sender, uint256 _amount, address _market)
        public
        returns (bool);

    function withdraw(address _recipient, uint256 _amount, address _market)
        public
        returns (bool);
